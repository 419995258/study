...
class GetTiebaInfo(object):
    ...
    def spider(self, urls):
        ...
        for url in urls:
            ...
            for tag in tagsli:
                ...
                item.href = 'http://tieba.baidu.com' + tag.find('a',attrs={'class': 'j_th_tit'}).get('href')
    ...
    def pipelines(self, items):
        fileName = u'百度贴吧-SNH48.txt'.encode('GBK')
            ...
            for item in items:
                fp.write(
                    ...
                    % (item.title.encode('utf8'), item.firstAuthor.encode('utf8'), item.firstTime.encode('utf8'),
                       ...
                       item.lastTime.encode('utf8'),item.href.encode('utf8')))
                '''fp.write(
                    'title:%s \t href:%s \n\n\n\n'
                    % (item.title.encode('utf8'), item.href.encode('utf8')))
